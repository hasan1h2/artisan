...
class WorkerAccountView extends GetView<WorkerAccountController> {
  ...
  Widget _buildProfileHeader() {
    return Container(
      ...
      padding: EdgeInsets.only(bottom: 60.h, top: 20.h),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.verified, color: AppColors.white, size: 14.sp),
                SizedBox(width: 4.w),
                Text(
                  "VERIFIED ARTISAN",
      ...
      children: [
        ...
        Obx(() => Wrap(
          ...
          children: controller.serviceAreas.map((area) => CustomChip(
            label: area,
            icon: Icon(Icons.location_on, size: 14.sp, color: AppColors.urgentRed),
          )).toList(),
        )),
      ],
    );
